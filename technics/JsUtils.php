...
class JsUtils {
	 ...
	 */
	 public static function getAndBindTo($element,$event,$url,$params="{}",$responseElement="",$function=NULL,$attr="id"){
	 ...
	 * @param string $function
	 */
	public static function postAndBindTo($element,$event,$url,$params="{}",$responseElement="",$function=NULL,$attr="id"){
	 ...
	 * @param string $function
	 */
	public static function postFormAndBindTo($element,$event,$url,$form,$responseElement="",$validation=false,$function=NULL,$attr="id"){
	 ...
	 * @return mixed
	 */
	public static function setAndBindTo($element,$event,$elementToModify,$value="",$function=""){
	 ...
	 * @return mixed
	 */
	public static function setHtmlAndBindTo($element,$event,$elementToModify,$value="",$function=""){
