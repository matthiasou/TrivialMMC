...
<script type="text/javascript" src="<?php echo $GLOBALS["siteUrl"]?>js/jquery-2.0.3.js"></script>
    ...
    <link type="text/css" href="<?php echo $GLOBALS["siteUrl"]?>css/jquery.toastmessage-min.css" rel="stylesheet"/>
    <script type="text/javascript" src="<?php echo $GLOBALS["siteUrl"]?>js/jquery-1.5.min.js"></script>
